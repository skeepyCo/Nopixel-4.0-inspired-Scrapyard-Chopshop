...
-- Custom Weapons Tier 1
	...
	["flatscreen"]     = { carry = true, model = "prop_tv_flat_03b", bone = 24817, x = -0.20, y = 0.43, z = 0.05, xr = 91.0,yr = 0.0, zr = -265.0, blockAttack = true, blockCar = true, blockRun = true },
	["atmred"] =  { carry = true, model = "flight_atm_03", bone = 28422, x = 0.01, y = -0.22, z = -0.8, xr = 0.0,yr = 0.0, zr = 0.0, blockAttack = true, blockCar = false, blockRun = true},
    ["atmblue"] =  { carry = true, model = "flight_atm_02", bone = 28422, x = 0.01, y = -0.22, z = -0.8, xr = 0.0,yr = 0.0, zr = 0.0, blockAttack = true, blockCar = false, blockRun = true},
    ["atmgreen"] =  { carry = true, model = "flight_fleeca_atm", bone = 28422, x = 0.01, y = -0.22, z = -0.8, xr = 0.0,yr = 0.0, zr = 0.0, blockAttack = true, blockCar = false, blockRun = true},
    ...
    ["flight_artpiece"]    = { carry = true, model = "v_res_sculpt_decf", bone = 24817, x = -0.25, y = 0.43, z = 0.00,xr = 0.0, yr = 90.0, zr = 0.0, blockAttack = true, blockCar = true, blockRun = true },
    ...
    ["flight_suitcase"]      = { carry = true, model = "prop_ld_suitcase_01", bone = 24817, x = -0.10, y = 0.43, z = 0.05, xr = 0.0,yr = 90.0, zr = 0.0, blockAttack = true, blockCar = true, blockRun = true },
    ["flight_television"]      = { carry = true, model = "sm_prop_smug_tv_flat_01", bone = 24817, x = -0.20, y = 0.43, z = 0.05, xr = 0.0,yr = -90.0, zr = 200.0, blockAttack = true, blockCar = true, blockRun = true },
    ["flight_painting"]    = { carry = true, model = "ch_prop_vault_painting_01c", bone = 24817, x = -0.25, y = 0.43, z = 0.05, xr = 180.0, yr = 90.0, zr = 0.0, blockAttack = true, blockCar = true, blockRun = true },
    ["flight_painting2"]    = { carry = true, model = "ch_prop_vault_painting_01d", bone = 24817, x = -0.25, y = 0.43, z = 0.05, xr = 180.0,yr = 90.0, zr = 0.0, blockAttack = true, blockCar = true, blockRun = true },
    ["flight_guitar"]      = { carry = true, model = "sf_prop_sf_guitar_case_01a", bone = 24817, x = -0.15, y = 0.50, z = 0.05, xr = 90.0,yr = 0.0, zr = 0.0, blockAttack = true, blockCar = true, blockRun = true },
    ...
    ["car_wheel"]      = { carry = true, model = "prop_wheel_02", bone = 24817, x = -0.20, y = 0.43, z = 0.05, xr = 0.0,yr = -90.0, zr = 200.0, blockAttack = true, blockCar = false, blockRun = false },
	["car_door"]       = { carry = true, model = "prop_car_door_01", bone = 24817, x = -0.23, y = 0.55, z = 0.05,xr = -10.0, yr = 93.0, zr = -10.0, blockAttack = true, blockCar = true, blockRun = true, },
	["radiator"]       = { carry = true, model = "imp_prop_impexp_radiator_01", bone = 24817, x = -0.20, y = 0.25, z = 0.05, xr = 0.10,yr = 90.0, zr = 0.0, blockAttack = true, blockCar = false, blockRun = false },
	["trunk"]          = { carry = true, model = "imp_prop_impexp_trunk_01a", bone = 24817, x = -0.100, y = 0.180, z = 0.05,xr = -180.0, yr = 93.0, zr = -10.0, blockAttack = true, blockCar = true, blockRun = true, },
}

local hash = GetHashKey("prop_phone_cs_frank")
RequestModel(hash)
